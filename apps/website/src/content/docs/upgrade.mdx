...
Version 2 upgrades the integration to **Astro 7** and **Vite 8**.

### Breaking changes

- **Astro 7 required** — Astro 6 projects must remain on `@qwik.dev/astro` v1
...
```bash
npm install astro@^7 @qwik.dev/astro@^2
```


## 1.0 Release

This release brought **Qwik v2** and **Astro 6+** support under the new package name.

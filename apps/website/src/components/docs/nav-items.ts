...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    description:
      "Qwik does not hydrate. Resumability is the ability to resume where the server left off.",
  ...
  },
  {
    ...
    description:
      "Astro uses partial hydration via islands, while Qwik uses resumable containers.",
  ...
  },
  {
    ...
    description:
      "Configure include paths to separate frameworks like Qwik, React, Preact, or Solid.",
  ...
  },
  {
    ...
    description:
      "Configure the Qwik Astro integration with options for build, dev, and more.",
  ...
  },
  {
    ...
    href: "/docs/faq",
    description:
      "Frequently asked questions about Qwik Astro integration and common issues.",
  ...
  },
  {
    ...
    description:
      "Learn how to contribute to the Qwik Astro project and help improve the integration.",
